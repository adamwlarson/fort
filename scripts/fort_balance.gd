...
static func camp(tier:int,crew:int)->Dictionary:
	crew=clampi(crew,1,4)
	return {"crew":crew,"escorts":crew,"boss_hp":(650.0+tier*100)*[.65,1.0,1.35,1.7][crew-1],"guard_hp":(100.0+tier*20)*(1+.08*(crew-1))}
